...
|**SERVICE**|FREE TIER?|SCOPE|**PURPOSE**|**KEY LEARNING**|
|-|-|-|-|-|
|IAM|Yes|Global|Controls access to resources|Users, Roles, Groups, Policies|
|EC2|Yes (Eligible instance types)|Regional|Creates instances of virtual servers|Instances, AMIs|
|EBS|Yes (Eligible instance types)|Regional|Block storage service|Persistent storage, Volumes|
